...
\nomenclature{$\Gamma$}{Potential energy between two molecules $\left[\Gamma\right]=\mathrm{J}$}
...
\nomenclature{$\mu$}{Magnitude of a dipole moment $\left[ \mu\right]=\mathrm{D}$}
...
\nomenclature{$\mu_{i}$}{Magnitude of a dipole moment $i$ $\left[ \mu\right]=\mathrm{D}$}
...
\nomenclature{$Q$}{Magnitude of quadrupole moment $\left[Q\right] = \mathrm{D}$}
...
\nomenclature{$\mu^{i}$}{Magnitude of induced dipole moment $\left[\mu^{i}\right] = \mathrm{D}$}
...
\nomenclature{$n$}{Positive constant in the repulsive interaction term of Mie's potential energy function}
\nomenclature{$m$}{Positive constant in the attractive interaction term of Mie's potential energy function}
